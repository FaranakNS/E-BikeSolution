...
//Added
builder.Services.PurchaseSystemDependencies(options =>
    options.UseSqlServer(connectionString));

builder.Services.ServicingSystemDependencies(options =>
    options.UseSqlServer(connectionString));

builder.Services.SalesReturnsSystemDependencies(options =>
    options.UseSqlServer(connectionString));

builder.Services.ReceivingSystemDependencies(options =>
    options.UseSqlServer(connectionString));
...
builder.Services.AddRazorPages(options =>
{
    ...
    options.Conventions.AuthorizeFolder("/ReceivingPages")
        .AllowAnonymousToPage("/ReceivingPages/Index");
    options.Conventions.AuthorizeFolder("/SalesReturnsPages")
        .AllowAnonymousToPage("/SalesReturnsPages/Index");
